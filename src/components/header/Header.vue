      ...
      <ul class="detail">
        ...
        <li>
          <Dropdown  placement="bottom-start">
            ...
            <DropdownMenu slot="list">
              <div class="shopping-cart-null" v-show="userOrder.length <= 0">
                <Icon type="ios-cart-outline" class="cart-null-icon"></Icon>
                <span>你的购物车没有空空哦</span>
                <span>赶快去添加商品吧~</span>
              </div>
              <div class="shopping-cart-list" v-show="userOrder.length > 0">
                <div class="shopping-cart-box" v-for="(item,index) in userOrder" :key="index">
