    ...
    <footer class="footer">
      ...
      <div class="icon-row">
        <div class="footer-icon">
          ...
          <span class="footer-icon-text">在这里，找到你的兴趣</span>
        </div>
        <div class="footer-icon">
          <h5 class="footer-icon-child footer-icon-child-2"></h5>
          <span class="footer-icon-text">顺丰无忧，极速配送</span>
        </div>
        <div class="footer-icon">
          <h5 class="footer-icon-child footer-icon-child-3"></h5>
          <span class="footer-icon-text">加入我们，精致服务</span>
        </div>
        <div class="footer-icon">
          <h5 class="footer-icon-child footer-icon-child-4"></h5>
          <span class="footer-icon-text">低价优品，畅选无忧</span>
        </div>
      </div>
      <div class="service-intro">
        ...
        <div class="clearfix"></div>
        <div class="copyright">
          <p>Copyright © 2018 by ZK <a href=""><Icon type="social-github"></Icon></a> <span>本项目仅供学习参考</span></p>
        </div>
      </div>
    </footer>
  </div>
...
export default {
  ...
  data () {
    return {
      ...
      guideArr: [
        [ '霍比特人', '拍卖流程', '会员介绍',  '常见问题', '专业收藏', '联系客服' ],
        [ '物流配送', '上门自提', '211限时达', '配送服务查询', '收取标准', '海外配送' ],
        [ '支付方式', '货到付款', '在线支付', '分期付款', '邮局汇款', '公司转账' ],
        [ '服务保障', '售后政策', '服务申明' ]
      ],
      moreLink: [
        '关于我们', '联系我们', '联系客服', '合作招商', '买家帮助', '营销中心', '跳蚤市场', '风险监测', '隐私政策'
      ]
    };
  }
};
...
.footer-icon-child {
  ...
  width: 36px;
  height: 42px;
  background-image: url("../../../public/img/footer/ico_service.png");
  text-indent: -999px;
}
.footer-icon-child-2 {
